...
//		if (air_no == 102) { printf("Now you select Air %d：\n", air_no); air_no = 0; }
//		if (air_no == 311) { printf("Now you select Air %d：\n", air_no); air_no = 1; };
//		if (air_no == 444) { printf("Now you select Air %d：\n", air_no); air_no = 2; };
//		if (air_no == 519) { printf("Now you select Air %d：\n", air_no); air_no = 3; };
//		while (getchar() != '\n') continue;
//		show_menu();
//		while ((selected = getchar()) != 'f'){
//			switch (selected){
